...
window = tk.Tk()
window.title("Christ University Attendace System")

window.geometry('1390x700')
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/Attendance/-------Check atttendance-------"')
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/User/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray)
...
def subjectchoose():
            ...
            if sub == '':
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if conf < 70:
                            print(conf)
                            subject = tx.get()  # Assuming `tx` is an Entry widget for subject input
                            ts = time.time()
                            date = datetime.datetime.fromtimestamp(ts).strftime('%Y-%m-%d')
                            timeStamp = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
                            student_name = df.loc[df['Enrollment'] == Id]['Name'].values
                            attendance.loc[len(attendance)] = [Id, student_name, date, timeStamp]
                            cv2.rectangle(im, (x, y), (x + w, y + h), (0, 260, 0), 7)
                            cv2.putText(im, str(Id) + "-" + student_name, (x + h, y), font, 1, (255, 255, 0,), 4)
                        else:
                            Id = 'Unknown'
                ...
                Hour, Minute, Second = timeStamp.split(":")
                Subject = tx.get()
                fileName = "C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/Attendance/" + Subject + "_" + date + \
                ...
                Notifica.configure(text=M, bg="black", fg="white",
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/Attendance' + fileName
    ...
    # Assuming `tx` is a global variable accessible within the function
    ...
    tx = tk.Entry(windo, width=20, bg="black",
                fg="white", font=('times', 23))
    tx.place(x=250, y=105)

    fill_a = tk.Button(windo, text="Fill Attendance", fg="white", command=Fillattendances, bg="pink", width=20, height=2,
                    activebackground="white", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'shrey':
            if password == 'shrey':
                ...
                cs = 'C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            # i've added some styling
                            label = tkinter.Label(root, width=10, height=1, fg="white", font=('times', 15, ' bold '),
                ...
                Nt.configure(text=valid, bg="black", fg="white",
    ...
    Nt = tk.Label(win, text="Attendance filled Successfully", bg="pink", fg="white", width=40,
                  height=2, font=('times', 19, 'bold'))
    # Nt.place(x=120, y=350)
    ...
    un_entr = tk.Entry(win, width=20, bg="black", fg="white",
                       font=('times', 23))
    ...
    pw_entr = tk.Entry(win, width=20, show="*", bg="black",
                       fg="white", font=('times', 23))
    ...
    Login = tk.Button(win, text="LogIn", fg="white", bg="black", width=20,
                      height=2,
                      activebackground="black", command=log_in, font=('times', 15, ' bold '))
...
def trainimg():
    ...
    global detector
    # detector = cv2.CascadeClassifier("C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/haarcascade_frontalface_default.xml")
    detector = cv2.CascadeClassifier("C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/haarcascade_frontalface_default.xml")
    try:
        global faces,Id
        # faces, Id = getImagesAndLabels("C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/TrainingImage/")
        faces, Id = getImagesAndLabels("C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/TrainingImage")
    except Exception as e:
        l = 'please make "TrainingImage" folder & put Images'
        Notification.configure(text=l, bg="black",
                               width=50, font=('times', 18, 'bold'))
        Notification.place(x=350, y=400)
        recognizer.train(faces, np.array(Id))
        recognizer.save("C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/TrainingImageLabel/Trainner.yml")
...
message = tk.Label(window, text=" CHRIST - AUTOMATIC ATTENDANCE MONITORING SYSTEM", bg="black", fg="white", width=50,
...
txt = tk.Entry(window, validate="key", width=20, bg="black",
...
txt2 = tk.Entry(window, width=20, bg="black",
                fg="white", font=('times', 25))
txt2.place(x=550, y=310)
clearButton = tk.Button(window, text="Clear", command=clear, fg="pink", bg="black",
                        width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear", command=clear1, fg="pink", bg="black",
                         width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="pink",
               bg="black", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="pink", bg="black",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="pink", command=trainimg, bg="black",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="pink", command=subjectchoose,
               bg="black", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Export Attendance", command=manually_fill, fg="pink",
                       bg="black", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
