...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
                ...
                with open(csv_name, newline="") as file:
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            ...
                            label = tkinter.Label(root, width=18, height=1, fg="white", font=('times', 13, ' bold '),
            ...
            DATA_SUB = tk.Button(MFW, text="Enter Data", command=enter_data_DB, fg="white", bg="SkyBlue1", width=20,
                                 height=2,
                                 activebackground="white", font=('times', 15, ' bold '))
            DATA_SUB.place(x=170, y=300)

            MAKE_CSV = tk.Button(MFW, text="Convert to CSV", command=create_csv, fg="white", bg="SkyBlue1", width=20,
                                 height=2,
                                 activebackground="white", font=('times', 15, ' bold '))
            MAKE_CSV.place(x=570, y=300)

            def attf():
                os.startfile("C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/Attendance/Manually Attendance")
    ...
    SUB = tk.Label(sb, text="Enter Subject : ", width=15, height=2,
                   fg="white", bg="grey80", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry(sb, width=20, bg="black",
                         fg="white", font=('times', 23))
    SUB_ENTRY.place(x=250, y=105)

    fill_manual_attendance = tk.Button(sb, text="Fill Attendance", command=fill_attendance, fg="white", bg="SkyBlue1", width=20, height=2,
                                       activebackground="white", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    Button(sc1, text='OK', command=del_sc1, fg="white", bg="lawn green", width=9,
...
def err_screen1():
    ...
    Label(sc2, text='Please enter your subject name!!!', fg='black',
          bg='white', font=('times', 16)).pack()
    Button(sc2, text='OK', command=del_sc2, fg="white", bg="lawn green", width=9,
           height=1, activebackground="Red", font=('times', 15, ' bold ')).place(x=90, y=50)
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    Notifica.configure(
                        text=e, bg="red", fg="white", width=33, font=('times', 15, 'bold'))
                ...
                root.configure(background='black')
                cs = 'C:/Users/Shrey/OneDrive/Desktop/zz/Face-Recognition-Attendance-System/' + fileName
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="white", command=Fillattendances, bg="red", width=20, height=2,
                       activebackground="white", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    Login = tk.Button(win, text="LogIn", fg="white", bg="red", width=20,
                      height=2,
...
takeImg = tk.Button(window, text="Take Images", command=take_img, fg="white", bg="red",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="white", command=trainimg, bg="red",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
